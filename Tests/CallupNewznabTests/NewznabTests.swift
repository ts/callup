...
@Test func decodesReportedCoverageWithoutInventingSeasonPackCoverage() throws {
    ...
    #expect(season.coverage.isEmpty)
    ...
    #expect(observedShape.coverage.isEmpty)
    #expect(observedShape.reportedTraits == ReportedReleaseTraits())
